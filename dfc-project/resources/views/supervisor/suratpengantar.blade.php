<x-app-layout>
    <div class="mr-8">
        ...
        <!-- Title -->
        <div class="my-6">
            <h1 class="text-3xl font-semibold mb-3">122/S.Peng/DFC/2025</h1>
            ...
            <div class="flex-1 bg-white rounded-xl shadow-lg border p-8">
                <form id="surat-tugas-form">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_surat_pemeriksaan" class="rounded-full border-[#3C4B64] w-full" placeholder="122/S.Peng/DFC/2025" value="122/S.Peng/DFC/2025" readonly>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="data_pemohon" class="rounded-full border-[#3C4B64] w-full" placeholder="Jane Doe" value="Jane Doe" readonly>
                    </div>
                    <div class="mb-4">
                        <p class="mb-1 text-[#3C4B64]">Nomor Surat Permintaan</p>
                        <input type="text" name="nomor_surat_permintaan" class="rounded-full border-[#3C4B64] w-full" placeholder="123/Req/2025" value="123/Req/2025" readonly>
                    </div>
                    <div class="mb-4">
                        <p class="mb-1 text-[#3C4B64]">Klasifikasi Surat</p>
                        <select name="klasifikasi_surat" class="rounded-full border-[#3C4B64] w-full" value="penting" readonly>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="barang-bukti-wrapper">
                            ...
                            <div class="flex items-center gap-2 mb-2">
                                <select name="barang_bukti[]" class="rounded-full border-[#3C4B64] w-full" value="dokumen" readonly>
                    ...
                    <div class="flex justify-center">
                        <a href="{{ route('supervisor.dashboard') }}" 
                           class="bg-white text-[#C4C4C4] border-2 border-[#C4C4C4] text-center w-full px-8 rounded-full py-2 mt-2 font-bold mr-4 hover:text-gray-900 hover:bg-gray-400">
                           Batalkan
                        </a>
                        <button type="submit" 
                                class="bg-[#10E653] text-white px-8 rounded-full w-full py-2 mt-2 font-bold hover:bg-blue-800">
                            Preview
                        </button>
                    </div>
                </form>
