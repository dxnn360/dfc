<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center gap-2">
                            <!-- Detail Button -->
                            <a href="{{ route('supervisor.surat-tugas.detail', $item->id) }}" 
                            ...
                            <!-- ACC Button -->
                            <form action="{{ route('supervisor.surat-tugas.approve', $item->id) }}" method="POST" class="inline">
                                @csrf
                                <button type="submit" 
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" 
                                    ...
                                    <div class="bg-white rounded-xl shadow-lg max-w-md w-full p-6" @click.away="open = false">
                                        ...
                                        <form action="{{ route('supervisor.surat-tugas.reject', $item->id) }}" method="POST">
                                            @csrf
    ...
    <div class="text-center py-12">
        ...
        <p class="text-gray-500 text-lg">Tidak ada data surat tugas</p>
    </div>
    @endif
</div>
