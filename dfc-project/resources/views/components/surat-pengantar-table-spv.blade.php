    ...
    <table class="w-full border-collapse rounded-xl overflow-hidden">
        <thead>
            <tr class="bg-[#979797] text-white text-center">
                <td class="p-2">No</td>
                <td class="p-2">Nomor Surat</td>
                <td class="p-2">Nama Pemohon</td>
        ...
        <tbody>
            <tr class="bg-[#F3F3F3] hover:bg-gray-100 text-center">
                <td class="p-2">1</td>
                <td class="p-2">SP/001/2024</td>
                <td class="p-2">Siti Aminah</td>
                <td class="p-2"><span class="px-3 py-1 rounded-full bg-blue-500 text-white text-xs">Proses</span></td>
