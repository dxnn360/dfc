<x-app-layout>
    <div class="min-h-screen bg-white py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                <!-- Form Section -->
                <div class="space-y-6">
                    <form method="POST" action="{{ route('analis.surat_pengantar.update', $surat_pengantar->id) }}"
                        id="form-surat">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="sumber_permohonan" id="sumber_permohonan"
                                        value="{{ old('sumber_permohonan', $surat_pengantar->sumber_permohonan) }}"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors"
                                        required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="alamat" id="alamat"
                                        value="{{ old('alamat', $surat_pengantar->alamat) }}"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors"
                                        required>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
                            ...
                            <div class="space-y-4">
                                <div id="barang-bukti-section" class="space-y-3">
                                    @php
                                        $barangBukti = old('barang_bukti', is_array($surat_pengantar->barang_bukti) ? $surat_pengantar->barang_bukti : json_decode($surat_pengantar->barang_bukti, true) ?? []);
                                    @endphp
    ...
    <style>
        ...
        /* Rata tengah untuk kolom kecil */
        .preview-table td:nth-child(1),
        .preview-table td:nth-child(3) {
            text-align: center;
        }

        /* Supaya tabel tidak terpotong di antar halaman saat print/pdf */
        .preview-table,
        .preview-table tr,
        .preview-table td,
        .preview-table th {
        ...
        /* Header tabel tetap muncul di halaman baru */
        thead {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function buildBarangBuktiTable() {
                ...
                // Awal tabel, pakai class yang sama dengan CSS
                let table = `
    ...
    `;
                ...
                inputs.forEach(el => {
                    ...
                    if (v !== '') {
                        // Escape karakter HTML biar aman
          ...
          <tr>
            ...
            <td>
              Dikirimkan kepada Kepala untuk dipergunakan seperlunya sesuai dengan @{{sumber_permohonan}}
            </td>
          </tr>
        `;
                        counter++;
